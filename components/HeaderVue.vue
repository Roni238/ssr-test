  ...
  <header>
    <div class="headerWrapp">
      ...
      <div class="nesw">
        ...
        <span class="reload-btn" :class="{ rotating: isRotating }"  @click="roloadPosts">
...
export default {
  ...
  methods: {
    roloadPosts() {
      ...
      this.$store.commit('postsModule/setSourceFilters', '')
      this.$store.commit('postsModule/setSearchParams', '')
      this.isRotating = !this.isRotating;
      setTimeout(()=>this.isRotating = !this.isRotating,500)
    }
  },
}
</script>
